                        ...
                        if colorScheme == .dark {
                            Group {
                                if UIDevice.current.userInterfaceIdiom == .pad {
                                    ...
                                    // the sign-up form card below the fold.
                                    // Use 220pt on iPad Mini landscape so
                                    // the form remains visible. Other iPad
                                    // size-classes (iPad 9th gen +, iPad
                                    // Air, iPad Pro) and orientations keep
                                    // the original 440pt unchanged.
